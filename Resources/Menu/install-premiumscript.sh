...
cd /usr/local/bin
wget -O premium-script.zip "https://raw.githubusercontent.com/SasukexSakura/AutoScriptDebian10/main/Resources/Menu/premium-script.zip"
tar -xvf premium-script.zip
